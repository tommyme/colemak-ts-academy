...
customUIKeyInput = qs('#customUIKeyInput');
...
var preferenceButton = qs('.preferenceButton'), preferenceMenu = qs('.preferenceMenu'), closePreferenceButton = qs('.closePreferenceButton'), capitalLettersAllowed = qs('.capitalLettersAllowed'), fullSentenceModeToggle = qs('.fullSentenceMode'), fullSentenceModeLevelButton = qs('.lvl8'), wordLimitModeButton = qs('.wordLimitModeButton'), wordLimitModeInput = qs('.wordLimitModeInput'), timeLimitModeButton = qs('.timeLimitModeButton'), timeLimitModeInput = qs('.timeLimitModeInput');
var wordScrollingModeButton = qs('.wordScrollingModeButton'), punctuationModeButton = qs('.punctuationModeButton');
start();
init();
